...
export default function Footer() {
    ...
    <section className={styles.footerWrapper}>
        ...
        <section className={styles.footerTitle}><div>
            ...
            <p className={styles.footerEmailHead}>Get the Latest Updates</p>
            </section>
          <section className={styles.footerRowAbout}>
    ...
    <section className={styles.footerWrapperInfo}>
        ...
        <section className={styles.footerTitle}>Graphique NFT</section>
        ...
        <section className={styles.footerColumn}>
        <section className={styles.footerTitle}>Support</section>
          <section className={styles.footerRow}>
            Help Center
          </section>
          <section className={styles.footerRow}>
    ...
    <section className={styles.copyright}>
        ...
        <p style={{float:'right'}}>
        <img src={insta} alt="Main Logo" className={styles.footerSocialMedia}/>
        <img src={twitter} alt="Main Logo" className={styles.footerSocialMedia}/>
        <img src={telegram} alt="Main Logo" className={styles.footerSocialMedia}/>
        <img src={discord} alt="Main Logo" className={styles.footerSocialMedia}/>
        </p>
    </section>
    </section>
    )
